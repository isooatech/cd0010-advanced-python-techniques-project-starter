...
class NearEarthObject:
    ...
    """
    # TODO: How can you, and should you,
    # change the arguments to this constructor?
    ...
    def __init__(self, **info):
        ...
        # onto attributes named `designation`, `name`,
        # `diameter`, and `hazardous`.
    ...
    def fullname(self):
        ...
        # TODO: Use self.designation and
        # self.name to build a fullname for this object.
        return f'{self.designation} {self.name}'

    def __str__(self):
        """Return `str(self)`."""
        # TODO: Use this object's attributes to
        ...
        if self.hazardous:
            ...
            hazard = "is not"
        return f"""A NearEarthObject {self.designation} has a
        diameter of {self.diameter} km and {hazard} potentially hazardous"""
...
class CloseApproach:
    ...
    initially, this information (the NEO's primary designation)
    is saved in a private attribute,
    ...
    def __init__(self, **info):
        ...
        A dictionary of excess keyword arguments supplied to the constructor.
        """
        # TODO: Assign information from
        # the arguments passed to the constructor
        # onto attributes named `_designation`,
        # `time`, `distance`, and `velocity`.
        # You should coerce these values to their appropriate
        # data type and handle any edge cases.
        # The `cd_to_datetime` function will be useful.
        self._designation = info['des'].strip()
        self.time = helpers.cd_to_datetime(info['cd'])
    ...
    def time_str(self):
        ...
        `datetime` object has a string
        representation, the default representation
        includes seconds - significant figures
        ...
        """
        # TODO: Use this object's `.time` attribute
        # and the `datetime_to_str` function to
        # build a formatted representation of the approach time.
        self.time = helpers.datetime_to_str(self.time)
        # TODO: Use self.designation and self.name
        # to build a fullname for this object.
        return f'{self.time}'

    def __str__(self):
        """Return `str(self)`."""
        # TODO: Use this object's attributes
        # to return a human-readable string representation.
        # The project instructions include
        # one possibility. Peek at the __repr__

        # method for examples of advanced string formatting.
        return f"""A CloseApproach {self._designation} approaches
        Earth on a {self.time} at a distance of {self.distance}
